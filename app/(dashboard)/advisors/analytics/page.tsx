								...
								(advisors ?? []).map((a: any) => {
									...
									return (
										<TableRow key={a.id} className="hover:bg-zinc-50">
											...
											<TableCell className="text-right font-semibold">{formatCurrency(s.revenue)}</TableCell>
											<TableCell className="text-right font-semibold text-red-600">{formatCurrency(s.due)}</TableCell>
