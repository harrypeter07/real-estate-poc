...
export const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  { label: "Advisors", href: "/advisors", icon: UserCheck, moduleKey: "advisors" },
  { label: "Advisor Analytics", href: "/advisor-analytics", icon: BarChart3, moduleKey: "advisor_analytics" },
  ...
  { label: "Due Payments", href: "/due-payments", icon: CreditCard, moduleKey: "due_payments" },
  ...
  { label: "Recovery", href: "/dashboard/recovery", icon: ShieldAlert, moduleKey: "recovery" },
