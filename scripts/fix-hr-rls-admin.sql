-- Run in Supabase SQL editor if HR inserts/upserts fail with RLS while the app lets you in.
-- Same as supabase/migrations/20260322140000_hr_rls_align_with_auth_route.sql
